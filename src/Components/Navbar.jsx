...
const Navbar = () => {
  ...
  return (
    <nav
      className={`bg-gray-800 p-4 flex justify-between items-center ${isHovered ? 'h-14' : 'h-10'}`} // Dynamic width based on hover state
      onMouseEnter={handleHover}
      onMouseLeave={handleLeave}
      // Add a unique ID for easier debugging (optional)
      id="my-navbar"
    >
      <div className="container mx-auto flex justify-start items-left">
